            ...
            this.data = f ? $.grep(this.options.data, function (item, i) {
              ...
              //console.log(item);
                for (var key in f) {
                  var flag = false;
                  for (var it in f[key]) {
                    //console.log('Selected: '+ f[key][it] + ' it: '+ it + ' item[it]: '+ item[it]);
                    $.each(item[it].split(', '),function(i,word)
                    {
                      if (item[it] != '' && f[key][it].includes(word) && word != '') {
                        flag = true;
                        //console.log('Selected: '+ f[key][it] + ' word: '+ word);
                      }
                    });
                    checkArr.push(flag);
                  }
