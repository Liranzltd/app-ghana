...
;(function($) {
   ...
   'use strict'
        ...
        if ( $('body').hasClass('header-sticky') ) {
            ...
            $(window).on('load scroll', function(){
                if ( $(window).scrollTop() > hd_height + 30 ) {
                    $('#site-header').addClass('downscrolled');
                } else {
                    $('#site-header').removeClass('downscrolled');
                }
                if( $(window).scrollTop() > 145 ) {
                    $('#site-header').addClass('upscrolled');
                } else {
                    $('#site-header').removeClass('upscrolled');
                }
            })
        }
    }
    ...
    //Right AD Slider Show
    var rightAdSlider = function() {
