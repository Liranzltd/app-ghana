...
// Returns the public 'monolog.logger.hubtel' shared service.

$this->services['monolog.logger.hubtel'] = $instance = new \Symfony\Bridge\Monolog\Logger('hubtel');
...
$instance->pushHandler(${($_ = isset($this->services['monolog.handler.hubtel']) ? $this->services['monolog.handler.hubtel'] : $this->load('getMonolog_Handler_HubtelService.php')) && false ?: '_'});
