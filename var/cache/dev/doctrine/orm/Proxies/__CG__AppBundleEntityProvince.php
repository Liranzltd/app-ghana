 ...
 */
class Province extends \AppBundle\Entity\Province implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Province' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Province' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Province' . "\0" . 'company', '' . "\0" . 'AppBundle\\Entity\\Province' . "\0" . 'companies'];
        }
