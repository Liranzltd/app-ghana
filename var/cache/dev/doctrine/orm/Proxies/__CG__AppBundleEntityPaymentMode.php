 ...
 */
class PaymentMode extends \AppBundle\Entity\PaymentMode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\PaymentMode' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\PaymentMode' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\PaymentMode' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\PaymentMode' . "\0" . 'instructions', '' . "\0" . 'AppBundle\\Entity\\PaymentMode' . "\0" . 'payments'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PaymentMode $proxy) {
