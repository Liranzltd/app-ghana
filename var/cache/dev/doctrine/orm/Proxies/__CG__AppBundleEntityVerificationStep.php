 ...
 */
class VerificationStep extends \AppBundle\Entity\VerificationStep implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\VerificationStep' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\VerificationStep' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\VerificationStep' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\VerificationStep' . "\0" . 'checkType', '' . "\0" . 'AppBundle\\Entity\\VerificationStep' . "\0" . 'stage', '' . "\0" . 'AppBundle\\Entity\\VerificationStep' . "\0" . 'mandatory'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VerificationStep $proxy) {
