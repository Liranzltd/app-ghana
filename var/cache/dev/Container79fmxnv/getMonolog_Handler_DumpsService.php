...
// Returns the private 'monolog.handler.dumps' shared service.

$this->services['monolog.handler.dumps'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/logs/dumps.log'), 100, true, NULL, false);
