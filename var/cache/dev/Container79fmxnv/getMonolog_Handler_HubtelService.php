...
// Returns the private 'monolog.handler.hubtel' shared service.

$this->services['monolog.handler.hubtel'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/logs/hubtel.log'), 100, true, NULL, false);
