...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/c')) {
            // _assetic_95e3465
            if ('/css/95e3465.css' === $pathinfo) {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '95e3465',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_95e3465',);
            }

            if (0 === strpos($pathinfo, '/css/95e3465_')) {
                // _assetic_95e3465_0
                if ('/css/95e3465_rfi_1.css' === $pathinfo) {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '95e3465',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_95e3465_0',);
                }

                // _assetic_95e3465_1
                if ('/css/95e3465_bootstrap-formhelpers.min_2.css' === $pathinfo) {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '95e3465',  'pos' => 1,  '_format' => 'css',  '_route' => '_assetic_95e3465_1',);
                }

                // _assetic_95e3465_2
                if ('/css/95e3465_sweetalert2.min_3.css' === $pathinfo) {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '95e3465',  'pos' => 2,  '_format' => 'css',  '_route' => '_assetic_95e3465_2',);
                }
        ...
        // _assetic_1d8cec4
        if ('/js/1d8cec4.js' === $pathinfo) {
            return array (  '_controller' => 'assetic.controller:render',  'name' => '1d8cec4',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_1d8cec4',);
        }

        if (0 === strpos($pathinfo, '/js/1d8cec4_')) {
            if (0 === strpos($pathinfo, '/js/1d8cec4_jquery.')) {
                // _assetic_1d8cec4_0
                if ('/js/1d8cec4_jquery.czMore-1.5.3.2_1.js' === $pathinfo) {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '1d8cec4',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_1d8cec4_0',);
                }

                // _assetic_1d8cec4_2
                if ('/js/1d8cec4_jquery.form.min_3.js' === $pathinfo) {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '1d8cec4',  'pos' => 2,  '_format' => 'js',  '_route' => '_assetic_1d8cec4_2',);
                }

                // _assetic_1d8cec4_5
                if ('/js/1d8cec4_jquery.fileupload_6.js' === $pathinfo) {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '1d8cec4',  'pos' => 5,  '_format' => 'js',  '_route' => '_assetic_1d8cec4_5',);
                }

                // _assetic_1d8cec4_3
                if ('/js/1d8cec4_jquery.ui.widget_4.js' === $pathinfo) {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '1d8cec4',  'pos' => 3,  '_format' => 'js',  '_route' => '_assetic_1d8cec4_3',);
                }

                // _assetic_1d8cec4_4
                if ('/js/1d8cec4_jquery.iframe-transport_5.js' === $pathinfo) {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '1d8cec4',  'pos' => 4,  '_format' => 'js',  '_route' => '_assetic_1d8cec4_4',);
                }

            }

            // _assetic_1d8cec4_1
            if ('/js/1d8cec4_jquery-ui_2.js' === $pathinfo) {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '1d8cec4',  'pos' => 1,  '_format' => 'js',  '_route' => '_assetic_1d8cec4_1',);
            }

            // _assetic_1d8cec4_6
            if ('/js/1d8cec4_sweetalert2.min_7.js' === $pathinfo) {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '1d8cec4',  'pos' => 6,  '_format' => 'js',  '_route' => '_assetic_1d8cec4_6',);
            }

            // _assetic_1d8cec4_7
            if ('/js/1d8cec4_functions_8.js' === $pathinfo) {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '1d8cec4',  'pos' => 7,  '_format' => 'js',  '_route' => '_assetic_1d8cec4_7',);
            }

            // _assetic_1d8cec4_8
            if ('/js/1d8cec4_rfijs_9.js' === $pathinfo) {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '1d8cec4',  'pos' => 8,  '_format' => 'js',  '_route' => '_assetic_1d8cec4_8',);
            }
        ...
        elseif (0 === strpos($pathinfo, '/a')) {
            if (0 === strpos($pathinfo, '/admin')) {
                ...
                if (0 === strpos($pathinfo, '/admin/app')) {
                    if (0 === strpos($pathinfo, '/admin/app/c')) {
                        if (0 === strpos($pathinfo, '/admin/app/company')) {
                            ...
                            if (preg_match('#^/admin/app/company/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_company_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.companies',  '_sonata_name' => 'admin_app_company_edit',));
                            }

                            // admin_app_company_delete
                            if (preg_match('#^/admin/app/company/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_company_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.companies',  '_sonata_name' => 'admin_app_company_delete',));
                            }

                            // admin_app_company_show
                            if (preg_match('#^/admin/app/company/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_company_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.companies',  '_sonata_name' => 'admin_app_company_show',));
                            }
                            ...
                            if (0 === strpos($pathinfo, '/admin/app/companyaddress')) {
                                ...
                                if (preg_match('#^/admin/app/companyaddress/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companyaddress_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.company_addresses',  '_sonata_name' => 'admin_app_companyaddress_edit',));
                                }

                                // admin_app_companyaddress_show
                                if (preg_match('#^/admin/app/companyaddress/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companyaddress_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.company_addresses',  '_sonata_name' => 'admin_app_companyaddress_show',));
                                }
                            ...
                            elseif (0 === strpos($pathinfo, '/admin/app/companycontact')) {
                                ...
                                if (preg_match('#^/admin/app/companycontact/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companycontact_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.company_contacts',  '_sonata_name' => 'admin_app_companycontact_edit',));
                                }

                                // admin_app_companycontact_show
                                if (preg_match('#^/admin/app/companycontact/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companycontact_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.company_contacts',  '_sonata_name' => 'admin_app_companycontact_show',));
                                }
                            ...
                            elseif (0 === strpos($pathinfo, '/admin/app/companydocumentation')) {
                                ...
                                if (preg_match('#^/admin/app/companydocumentation/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companydocumentation_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.company_documents',  '_sonata_name' => 'admin_app_companydocumentation_edit',));
                                }

                                // admin_app_companydocumentation_show
                                if (preg_match('#^/admin/app/companydocumentation/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companydocumentation_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.company_documents',  '_sonata_name' => 'admin_app_companydocumentation_show',));
                                }
                            ...
                            elseif (0 === strpos($pathinfo, '/admin/app/companydirector')) {
                                ...
                                if (preg_match('#^/admin/app/companydirector/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companydirector_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.company_directors',  '_sonata_name' => 'admin_app_companydirector_edit',));
                                }

                                // admin_app_companydirector_show
                                if (preg_match('#^/admin/app/companydirector/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companydirector_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.company_directors',  '_sonata_name' => 'admin_app_companydirector_show',));
                                }
                            ...
                            elseif (0 === strpos($pathinfo, '/admin/app/companyshareholding')) {
                                ...
                                if (preg_match('#^/admin/app/companyshareholding/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companyshareholding_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.company_shareholding',  '_sonata_name' => 'admin_app_companyshareholding_edit',));
                                }

                                // admin_app_companyshareholding_show
                                if (preg_match('#^/admin/app/companyshareholding/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companyshareholding_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.company_shareholding',  '_sonata_name' => 'admin_app_companyshareholding_show',));
                                }
                            ...
                            elseif (0 === strpos($pathinfo, '/admin/app/companytype')) {
                                ...
                                if (preg_match('#^/admin/app/companytype/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companytype_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.company_types',  '_sonata_name' => 'admin_app_companytype_edit',));
                                }

                                // admin_app_companytype_delete
                                if (preg_match('#^/admin/app/companytype/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companytype_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.company_types',  '_sonata_name' => 'admin_app_companytype_delete',));
                                }

                                // admin_app_companytype_show
                                if (preg_match('#^/admin/app/companytype/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companytype_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.company_types',  '_sonata_name' => 'admin_app_companytype_show',));
                                }
                                ...
                                if (0 === strpos($pathinfo, '/admin/app/companytypedocumentation')) {
                                    ...
                                    if (preg_match('#^/admin/app/companytypedocumentation/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companytypedocumentation_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.company_type_documentation',  '_sonata_name' => 'admin_app_companytypedocumentation_edit',));
                                    }
                                    ...
                                    if (preg_match('#^/admin/app/companytypedocumentation/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companytypedocumentation_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.company_type_documentation',  '_sonata_name' => 'admin_app_companytypedocumentation_delete',));
                                    }

                                    // admin_app_companytypedocumentation_show
                                    if (preg_match('#^/admin/app/companytypedocumentation/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companytypedocumentation_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.company_type_documentation',  '_sonata_name' => 'admin_app_companytypedocumentation_show',));
                                    }
                            ...
                            elseif (0 === strpos($pathinfo, '/admin/app/companyreference')) {
                                ...
                                if (preg_match('#^/admin/app/companyreference/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companyreference_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.company_references',  '_sonata_name' => 'admin_app_companyreference_edit',));
                                }

                                // admin_app_companyreference_show
                                if (preg_match('#^/admin/app/companyreference/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companyreference_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.company_references',  '_sonata_name' => 'admin_app_companyreference_show',));
                                }
                            ...
                            elseif (0 === strpos($pathinfo, '/admin/app/companyrequest')) {
                                ...
                                if (preg_match('#^/admin/app/companyrequest/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companyrequest_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.company_requests',  '_sonata_name' => 'admin_app_companyrequest_edit',));
                                }

                                // admin_app_companyrequest_show
                                if (preg_match('#^/admin/app/companyrequest/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companyrequest_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.company_requests',  '_sonata_name' => 'admin_app_companyrequest_show',));
                                }
                            ...
                            elseif (0 === strpos($pathinfo, '/admin/app/companyverification')) {
                                ...
                                if (preg_match('#^/admin/app/companyverification/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companyverification_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.company_verification',  '_sonata_name' => 'admin_app_companyverification_edit',));
                                }

                                // admin_app_companyverification_delete
                                if (preg_match('#^/admin/app/companyverification/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companyverification_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.company_verification',  '_sonata_name' => 'admin_app_companyverification_delete',));
                                }

                                // admin_app_companyverification_show
                                if (preg_match('#^/admin/app/companyverification/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_companyverification_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.company_verification',  '_sonata_name' => 'admin_app_companyverification_show',));
                                }
                        ...
                        elseif (0 === strpos($pathinfo, '/admin/app/contentcategory')) {
                            ...
                            if (preg_match('#^/admin/app/contentcategory/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_contentcategory_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.content_categories',  '_sonata_name' => 'admin_app_contentcategory_edit',));
                            }

                            // admin_app_contentcategory_delete
                            if (preg_match('#^/admin/app/contentcategory/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_contentcategory_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.content_categories',  '_sonata_name' => 'admin_app_contentcategory_delete',));
                            }

                            // admin_app_contentcategory_show
                            if (preg_match('#^/admin/app/contentcategory/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_contentcategory_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.content_categories',  '_sonata_name' => 'admin_app_contentcategory_show',));
                            }
                        ...
                        elseif (0 === strpos($pathinfo, '/admin/app/category')) {
                            ...
                            if (preg_match('#^/admin/app/category/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_category_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.categories',  '_sonata_name' => 'admin_app_category_edit',));
                            }

                            // admin_app_category_delete
                            if (preg_match('#^/admin/app/category/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_category_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.categories',  '_sonata_name' => 'admin_app_category_delete',));
                            }

                            // admin_app_category_show
                            if (preg_match('#^/admin/app/category/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_category_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.categories',  '_sonata_name' => 'admin_app_category_show',));
                            }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/documenttype')) {
                        ...
                        if (preg_match('#^/admin/app/documenttype/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_documenttype_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.documents_types',  '_sonata_name' => 'admin_app_documenttype_edit',));
                        }

                        // admin_app_documenttype_delete
                        if (preg_match('#^/admin/app/documenttype/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_documenttype_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.documents_types',  '_sonata_name' => 'admin_app_documenttype_delete',));
                        }

                        // admin_app_documenttype_show
                        if (preg_match('#^/admin/app/documenttype/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_documenttype_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.documents_types',  '_sonata_name' => 'admin_app_documenttype_show',));
                        }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/buyer')) {
                        ...
                        if (preg_match('#^/admin/app/buyer/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_buyer_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.buyers',  '_sonata_name' => 'admin_app_buyer_edit',));
                        }

                        // admin_app_buyer_delete
                        if (preg_match('#^/admin/app/buyer/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_buyer_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.buyers',  '_sonata_name' => 'admin_app_buyer_delete',));
                        }

                        // admin_app_buyer_show
                        if (preg_match('#^/admin/app/buyer/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_buyer_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.buyers',  '_sonata_name' => 'admin_app_buyer_show',));
                        }
                        ...
                        if (0 === strpos($pathinfo, '/admin/app/buyermembership')) {
                            ...
                            if (preg_match('#^/admin/app/buyermembership/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_buyermembership_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.buyer_membership',  '_sonata_name' => 'admin_app_buyermembership_edit',));
                            }

                            // admin_app_buyermembership_show
                            if (preg_match('#^/admin/app/buyermembership/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_buyermembership_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.buyer_membership',  '_sonata_name' => 'admin_app_buyermembership_show',));
                            }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/businessgrowthhub')) {
                        ...
                        if (preg_match('#^/admin/app/businessgrowthhub/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_businessgrowthhub_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.ujuzi_hub',  '_sonata_name' => 'admin_app_businessgrowthhub_edit',));
                        }

                        // admin_app_businessgrowthhub_delete
                        if (preg_match('#^/admin/app/businessgrowthhub/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_businessgrowthhub_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.ujuzi_hub',  '_sonata_name' => 'admin_app_businessgrowthhub_delete',));
                        }

                        // admin_app_businessgrowthhub_show
                        if (preg_match('#^/admin/app/businessgrowthhub/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_businessgrowthhub_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.ujuzi_hub',  '_sonata_name' => 'admin_app_businessgrowthhub_show',));
                        }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/member')) {
                        ...
                        if (preg_match('#^/admin/app/member/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_member_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.members',  '_sonata_name' => 'admin_app_member_edit',));
                        }

                        // admin_app_member_delete
                        if (preg_match('#^/admin/app/member/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_member_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.members',  '_sonata_name' => 'admin_app_member_delete',));
                        }

                        // admin_app_member_show
                        if (preg_match('#^/admin/app/member/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_member_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.members',  '_sonata_name' => 'admin_app_member_show',));
                        }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/payment')) {
                        ...
                        if (preg_match('#^/admin/app/payment/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_payment_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.payments',  '_sonata_name' => 'admin_app_payment_show',));
                        }
                        ...
                        if (0 === strpos($pathinfo, '/admin/app/paymentmode')) {
                            ...
                            if (preg_match('#^/admin/app/paymentmode/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_paymentmode_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.payment_modes',  '_sonata_name' => 'admin_app_paymentmode_edit',));
                            }

                            // admin_app_paymentmode_delete
                            if (preg_match('#^/admin/app/paymentmode/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_paymentmode_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.payment_modes',  '_sonata_name' => 'admin_app_paymentmode_delete',));
                            }

                            // admin_app_paymentmode_show
                            if (preg_match('#^/admin/app/paymentmode/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_paymentmode_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.payment_modes',  '_sonata_name' => 'admin_app_paymentmode_show',));
                            }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/promocode')) {
                        ...
                        if (preg_match('#^/admin/app/promocode/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_promocode_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.promo_codes',  '_sonata_name' => 'admin_app_promocode_edit',));
                        }

                        // admin_app_promocode_delete
                        if (preg_match('#^/admin/app/promocode/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_promocode_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.promo_codes',  '_sonata_name' => 'admin_app_promocode_delete',));
                        }

                        // admin_app_promocode_show
                        if (preg_match('#^/admin/app/promocode/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_promocode_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.promo_codes',  '_sonata_name' => 'admin_app_promocode_show',));
                        }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/request')) {
                        ...
                        if (preg_match('#^/admin/app/request/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_request_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.requests',  '_sonata_name' => 'admin_app_request_edit',));
                        }

                        // admin_app_request_show
                        if (preg_match('#^/admin/app/request/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_request_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.requests',  '_sonata_name' => 'admin_app_request_show',));
                        }
                        ...
                        if (0 === strpos($pathinfo, '/admin/app/requesttype')) {
                            ...
                            if (preg_match('#^/admin/app/requesttype/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_requesttype_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.requests_type',  '_sonata_name' => 'admin_app_requesttype_edit',));
                            }

                            // admin_app_requesttype_delete
                            if (preg_match('#^/admin/app/requesttype/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_requesttype_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.requests_type',  '_sonata_name' => 'admin_app_requesttype_delete',));
                            }

                            // admin_app_requesttype_show
                            if (preg_match('#^/admin/app/requesttype/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_requesttype_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.requests_type',  '_sonata_name' => 'admin_app_requesttype_show',));
                            }
                        ...
                        elseif (0 === strpos($pathinfo, '/admin/app/requestdocument')) {
                            ...
                            if (preg_match('#^/admin/app/requestdocument/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_requestdocument_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.requests_documents',  '_sonata_name' => 'admin_app_requestdocument_edit',));
                            }

                            // admin_app_requestdocument_delete
                            if (preg_match('#^/admin/app/requestdocument/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_requestdocument_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.requests_documents',  '_sonata_name' => 'admin_app_requestdocument_delete',));
                            }

                            // admin_app_requestdocument_show
                            if (preg_match('#^/admin/app/requestdocument/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_requestdocument_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.requests_documents',  '_sonata_name' => 'admin_app_requestdocument_show',));
                            }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/article')) {
                        ...
                        if (preg_match('#^/admin/app/article/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_article_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.news',  '_sonata_name' => 'admin_app_article_edit',));
                        }

                        // admin_app_article_delete
                        if (preg_match('#^/admin/app/article/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_article_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.news',  '_sonata_name' => 'admin_app_article_delete',));
                        }

                        // admin_app_article_show
                        if (preg_match('#^/admin/app/article/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_article_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.news',  '_sonata_name' => 'admin_app_article_show',));
                        }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/testimonial')) {
                        ...
                        if (preg_match('#^/admin/app/testimonial/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_testimonial_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.testimonials',  '_sonata_name' => 'admin_app_testimonial_edit',));
                        }

                        // admin_app_testimonial_delete
                        if (preg_match('#^/admin/app/testimonial/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_testimonial_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.testimonials',  '_sonata_name' => 'admin_app_testimonial_delete',));
                        }

                        // admin_app_testimonial_show
                        if (preg_match('#^/admin/app/testimonial/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_testimonial_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.testimonials',  '_sonata_name' => 'admin_app_testimonial_show',));
                        }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/verificationstage')) {
                        ...
                        if (preg_match('#^/admin/app/verificationstage/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_verificationstage_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.verification_stages',  '_sonata_name' => 'admin_app_verificationstage_edit',));
                        }

                        // admin_app_verificationstage_delete
                        if (preg_match('#^/admin/app/verificationstage/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_verificationstage_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.verification_stages',  '_sonata_name' => 'admin_app_verificationstage_delete',));
                        }

                        // admin_app_verificationstage_show
                        if (preg_match('#^/admin/app/verificationstage/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_verificationstage_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.verification_stages',  '_sonata_name' => 'admin_app_verificationstage_show',));
                        }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/verificationstep')) {
                        ...
                        if (preg_match('#^/admin/app/verificationstep/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_verificationstep_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.verification_step',  '_sonata_name' => 'admin_app_verificationstep_edit',));
                        }

                        // admin_app_verificationstep_delete
                        if (preg_match('#^/admin/app/verificationstep/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_verificationstep_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.verification_step',  '_sonata_name' => 'admin_app_verificationstep_delete',));
                        }

                        // admin_app_verificationstep_show
                        if (preg_match('#^/admin/app/verificationstep/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_verificationstep_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.verification_step',  '_sonata_name' => 'admin_app_verificationstep_show',));
                        }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/staff')) {
                        ...
                        if (preg_match('#^/admin/app/staff/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_staff_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.staff',  '_sonata_name' => 'admin_app_staff_edit',));
                        }

                        // admin_app_staff_delete
                        if (preg_match('#^/admin/app/staff/(?P<id>[^/]++)/delete$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_staff_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'admin.staff',  '_sonata_name' => 'admin_app_staff_delete',));
                        }

                        // admin_app_staff_show
                        if (preg_match('#^/admin/app/staff/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_staff_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.staff',  '_sonata_name' => 'admin_app_staff_show',));
                        }
                    ...
                    elseif (0 === strpos($pathinfo, '/admin/app/userguide')) {
                        if (0 === strpos($pathinfo, '/admin/app/userguidetopic')) {
                            ...
                            if (preg_match('#^/admin/app/userguidetopic/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_userguidetopic_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.user_guide.topic',  '_sonata_name' => 'admin_app_userguidetopic_edit',));
                            }

                            // admin_app_userguidetopic_show
                            if (preg_match('#^/admin/app/userguidetopic/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                                return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_userguidetopic_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.user_guide.topic',  '_sonata_name' => 'admin_app_userguidetopic_show',));
                            }
                        ...
                        if (preg_match('#^/admin/app/userguide/(?P<id>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_userguide_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'admin.user_guide.content',  '_sonata_name' => 'admin_app_userguide_edit',));
                        }

                        // admin_app_userguide_show
                        if (preg_match('#^/admin/app/userguide/(?P<id>[^/]++)/show$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_app_userguide_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'admin.user_guide.content',  '_sonata_name' => 'admin_app_userguide_show',));
                        }
                ...
                if (0 === strpos($pathinfo, '/admin/downloadfile') && preg_match('#^/admin/downloadfile/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_dashboard_download')), array (  '_controller' => 'AppBundle\\Controller\\DashboardController::downloadAction',  'category' => NULL,));
                }
            ...
            if (0 === strpos($pathinfo, '/articles') && preg_match('#^/articles(?:/(?P<category>[^/]++)(?:/(?P<slug>[^/]++))?)?$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'articles')), array (  'category' => NULL,  'slug' => '',  '_controller' => 'AppBundle\\Controller\\DefaultController::articlesAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/business-growth-hub')) {
            ...
            if (preg_match('#^/business\\-growth\\-hub/(?P<category>[^/]++)/(?P<slug>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'business-growth-hub-show')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::businessGrowthHubShowAction',  'category' => NULL,));
            }

        }

        // business-linkage-programme
        if ('/business-linkage-programme' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::businessLinkageProgrammeAction',  'category' => NULL,  '_route' => 'business-linkage-programme',);
        }
        ...
        if (0 === strpos($pathinfo, '/s')) {
            ...
            if (0 === strpos($pathinfo, '/services/downloadfile') && preg_match('#^/services/downloadfile/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'app_services_download')), array (  '_controller' => 'AppBundle\\Controller\\ServicesController::downloadAction',  'category' => NULL,));
            }
        ...
        elseif (0 === strpos($pathinfo, '/p')) {
            if (0 === strpos($pathinfo, '/portal')) {
                // get-started
                if ('/portal/get-started' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/portal/buyer')) {
                    ...
                    if (preg_match('#^/portal/buyer/(?P<slug>[^/]++)$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, array('_route' => 'buyer-dashboard')), array (  '_controller' => 'AppBundle\\Controller\\PortalController::buyerDashboardAction',  'category' => NULL,));
                        if (!in_array($canonicalMethod, array('GET'))) {
                            $allow = array_merge($allow, array('GET'));
                    ...
                    if (preg_match('#^/portal/buyer/(?P<slug>[^/]++)/requests$#sD', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'buyer-dashboard-requests')), array (  '_controller' => 'AppBundle\\Controller\\PortalController::buyerRequestsAction',  'category' => NULL,));
                    }

                    // buyer-new-request
                    if (preg_match('#^/portal/buyer/(?P<slug>[^/]++)/new\\-request$#sD', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'buyer-new-request')), array (  '_controller' => 'AppBundle\\Controller\\PortalController::buyerNewRequestAction',  'category' => NULL,));
                    }

                    // buyer-edit-request
                    if (0 === strpos($pathinfo, '/portal/buyer/edit-request') && preg_match('#^/portal/buyer/edit\\-request/(?P<slug>[^/]++)$#sD', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'buyer-edit-request')), array (  '_controller' => 'AppBundle\\Controller\\PortalController::buyerEditRequestAction',  'category' => NULL,));
                    }
                    ...
                    if (preg_match('#^/portal/buyer/(?P<slug>[^/]++)/team\\-members$#sD', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'team-members')), array (  '_controller' => 'AppBundle\\Controller\\PortalController::buyerTeamAction',  'category' => NULL,));
                    }

                    // buyer-dashboard-suppliers
                    if (preg_match('#^/portal/buyer/(?P<slug>[^/]++)/suppliers(?:/(?P<pool>\\d+))?$#sD', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'buyer-dashboard-suppliers')), array (  'pool' => NULL,  '_controller' => 'AppBundle\\Controller\\PortalController::buyerSuppliersAction',  'category' => NULL,));
                    }
                    ...
                    if (preg_match('#^/portal/buyer/(?P<slug>[^/]++)/add\\-to\\-team$#sD', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'add-to-team')), array (  '_controller' => 'AppBundle\\Controller\\PortalController::buyerAddToTeamAction',  'category' => NULL,));
                    }
                ...
                elseif (0 === strpos($pathinfo, '/portal/s')) {
                    if (0 === strpos($pathinfo, '/portal/supplier')) {
                        ...
                        if (0 === strpos($pathinfo, '/portal/supplier/respond') && preg_match('#^/portal/supplier/respond/(?P<slug>[^/]++)$#sD', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'respond-to-request')), array (  '_controller' => 'AppBundle\\Controller\\PortalController::supplierRequestRespondAction',  'category' => NULL,));
                        }
                    ...
                    // app_portal_singleupload
                    if ('/portal/singleUpload' === $pathinfo) {
                        return array (  '_controller' => 'AppBundle\\Controller\\PortalController::singleUploadAction',  'category' => NULL,  '_route' => 'app_portal_singleupload',);
                    }
                ...
                if (0 === strpos($pathinfo, '/portal/re')) {
                    ...
                    // app_portal_removecompanycomponent
                    if ('/portal/remove-component' === $pathinfo) {
                        return array (  '_controller' => 'AppBundle\\Controller\\PortalController::removeCompanyComponentAction',  'category' => NULL,  '_route' => 'app_portal_removecompanycomponent',);
                    }
                ...
                if (0 === strpos($pathinfo, '/portal/edit-buyer') && preg_match('#^/portal/edit\\-buyer/(?P<slug>[^/]++)(?:/(?P<tab>[^/]++))?$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'edit-buyer')), array (  'tab' => NULL,  '_controller' => 'AppBundle\\Controller\\PortalController::editBuyerAction',  'category' => NULL,));
                }

                // edit-company
                if (0 === strpos($pathinfo, '/portal/edit-company') && preg_match('#^/portal/edit\\-company/(?P<slug>[^/]++)(?:/(?P<tab>[^/]++))?$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'edit-company')), array (  'tab' => NULL,  '_controller' => 'AppBundle\\Controller\\PortalController::editCompanyAction',  'category' => NULL,));
                }
                ...
                if (0 === strpos($pathinfo, '/portal/download')) {
                    ...
                    if (0 === strpos($pathinfo, '/portal/downloadfile') && preg_match('#^/portal/downloadfile/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'downloadCompanyDocument')), array (  '_controller' => 'AppBundle\\Controller\\PortalController::downloadCompanyDocumentAction',  'category' => NULL,));
                    }
                    ...
                    if (0 === strpos($pathinfo, '/portal/download-request-file') && preg_match('#^/portal/download\\-request\\-file/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'downloadBuyerDocument')), array (  '_controller' => 'AppBundle\\Controller\\PortalController::downloadBuyerDocumentAction',  'category' => NULL,));
                    }
                    ...
                    if (0 === strpos($pathinfo, '/portal/download-response-file') && preg_match('#^/portal/download\\-response\\-file/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'downloadResponseDocument')), array (  '_controller' => 'AppBundle\\Controller\\PortalController::downloadResponseDocumentAction',  'category' => NULL,));
                    }
                ...
                if (0 === strpos($pathinfo, '/portal/delete-request-file') && preg_match('#^/portal/delete\\-request\\-file/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'deleteBuyerDocument')), array (  '_controller' => 'AppBundle\\Controller\\PortalController::deleteBuyerDocumentAction',  'category' => NULL,));
                }
        ...
        if (0 === strpos($pathinfo, '/upgrade')) {
            ...
            if (0 === strpos($pathinfo, '/upgrade/update_company_details') && preg_match('#^/upgrade/update_company_details/(?P<slug>[^/]++)(?:/(?P<tab>[^/]++))?$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'update_company_details')), array (  'tab' => NULL,  '_controller' => 'AppBundle\\Controller\\RecollectionController::updateCompanyDetails',  'category' => NULL,));
            }
        ...
        elseif (0 === strpos($pathinfo, '/re')) {
            ...
            if (0 === strpos($pathinfo, '/request') && preg_match('#^/request/(?P<id>[^/]++)$#sD', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'show-request')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::requestAction',  'category' => NULL,));
            }
        ...
        elseif (0 === strpos($pathinfo, '/te')) {
            if (0 === strpos($pathinfo, '/tenderspace')) {
                ...
                if (0 === strpos($pathinfo, '/tenderspace/tenders') && preg_match('#^/tenderspace/tenders/(?P<slug>[^/]++)$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'tenda')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::tendaAction',  'category' => NULL,));
                }

                // tenderspace
                if (preg_match('#^/tenderspace(?:/(?P<category>[^/]++)(?:/(?P<subcategory>[^/]++)(?:/(?P<orderby>[^/]++))?)?)?$#sD', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'tenderspace')), array (  'category' => NULL,  'subcategory' => 'all-subcategories',  'orderby' => 'newest',  '_controller' => 'AppBundle\\Controller\\DefaultController::tenderspaceAction',));
                }
