 ...
 */
class CompanyShareholding extends \AppBundle\Entity\CompanyShareholding implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CompanyShareholding' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\CompanyShareholding' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\CompanyShareholding' . "\0" . 'nationality', '' . "\0" . 'AppBundle\\Entity\\CompanyShareholding' . "\0" . 'shares', '' . "\0" . 'AppBundle\\Entity\\CompanyShareholding' . "\0" . 'company', '' . "\0" . 'AppBundle\\Entity\\CompanyShareholding' . "\0" . 'percentage'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompanyShareholding $proxy) {
