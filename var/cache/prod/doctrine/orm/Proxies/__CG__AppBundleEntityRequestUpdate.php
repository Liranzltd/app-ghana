 ...
 */
class RequestUpdate extends \AppBundle\Entity\RequestUpdate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\RequestUpdate' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\RequestUpdate' . "\0" . 'status', '' . "\0" . 'AppBundle\\Entity\\RequestUpdate' . "\0" . 'remarks', '' . "\0" . 'AppBundle\\Entity\\RequestUpdate' . "\0" . 'actionDate', '' . "\0" . 'AppBundle\\Entity\\RequestUpdate' . "\0" . 'request', '' . "\0" . 'AppBundle\\Entity\\RequestUpdate' . "\0" . 'member'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RequestUpdate $proxy) {
