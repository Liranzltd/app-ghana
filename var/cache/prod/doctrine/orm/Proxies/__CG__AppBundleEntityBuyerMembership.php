 ...
 */
class BuyerMembership extends \AppBundle\Entity\BuyerMembership implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BuyerMembership' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\BuyerMembership' . "\0" . 'isAdmin', '' . "\0" . 'AppBundle\\Entity\\BuyerMembership' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\BuyerMembership' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\BuyerMembership' . "\0" . 'member', '' . "\0" . 'AppBundle\\Entity\\BuyerMembership' . "\0" . 'buyer', '' . "\0" . 'AppBundle\\Entity\\BuyerMembership' . "\0" . 'isDisabled'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BuyerMembership $proxy) {
