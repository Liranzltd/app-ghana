...
class Task extends \AppBundle\Entity\Task implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'subject', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'status', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'dueDate', '' . "\0" . 'AppBundle\\Entity\\Task' . "\0" . 'staff'];
        }
