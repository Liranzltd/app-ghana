...
class PromoCode extends \AppBundle\Entity\PromoCode implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\PromoCode' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\PromoCode' . "\0" . 'code', '' . "\0" . 'AppBundle\\Entity\\PromoCode' . "\0" . 'amountOff', '' . "\0" . 'AppBundle\\Entity\\PromoCode' . "\0" . 'isPercentage', '' . "\0" . 'AppBundle\\Entity\\PromoCode' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\PromoCode' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\PromoCode' . "\0" . 'payments', '' . "\0" . 'AppBundle\\Entity\\PromoCode' . "\0" . 'expiryDate', '' . "\0" . 'AppBundle\\Entity\\PromoCode' . "\0" . 'companies'];
        }
    ...
    public function setAmountOff($amountOff)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAmountOff', [$amountOff]);

        return parent::setAmountOff($amountOff);
    }
    ...
    public function getAmountOff()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAmountOff', []);

        return parent::getAmountOff();
    }
