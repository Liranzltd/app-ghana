 ...
 */
class ContentCategory extends \AppBundle\Entity\ContentCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ContentCategory' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ContentCategory' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\ContentCategory' . "\0" . 'slug', '' . "\0" . 'AppBundle\\Entity\\ContentCategory' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\ContentCategory' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\ContentCategory' . "\0" . 'children', '' . "\0" . 'AppBundle\\Entity\\ContentCategory' . "\0" . 'parent', '' . "\0" . 'AppBundle\\Entity\\ContentCategory' . "\0" . 'articles', '' . "\0" . 'AppBundle\\Entity\\ContentCategory' . "\0" . 'ujuzihub', 'file', '' . "\0" . 'AppBundle\\Entity\\ContentCategory' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\ContentCategory' . "\0" . 'banner', '' . "\0" . 'AppBundle\\Entity\\ContentCategory' . "\0" . 'growthub'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContentCategory $proxy) {
    ...
    public function addUjuzihub(\AppBundle\Entity\UjuziHub $ujuzihub)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addUjuzihub', [$ujuzihub]);

        return parent::addUjuzihub($ujuzihub);
    }
    ...
    public function removeUjuzihub(\AppBundle\Entity\UjuziHub $ujuzihub)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeUjuzihub', [$ujuzihub]);

        return parent::removeUjuzihub($ujuzihub);
    }
    ...
    public function getUjuzihub()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUjuzihub', []);

        return parent::getUjuzihub();
    }
    ...
    public function addGrowthub(\AppBundle\Entity\BusinessGrowthHub $growthub)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addGrowthub', [$growthub]);

        return parent::addGrowthub($growthub);
    }
    ...
    public function removeGrowthub(\AppBundle\Entity\BusinessGrowthHub $growthub)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeGrowthub', [$growthub]);

        return parent::removeGrowthub($growthub);
    }
    ...
    public function getGrowthub()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGrowthub', []);

        return parent::getGrowthub();
    }
