...
class Notification extends \AppBundle\Entity\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Notification' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Notification' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Notification' . "\0" . 'message', '' . "\0" . 'AppBundle\\Entity\\Notification' . "\0" . 'company', '' . "\0" . 'AppBundle\\Entity\\Notification' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Notification' . "\0" . 'isRead', '' . "\0" . 'AppBundle\\Entity\\Notification' . "\0" . 'buyer'];
        }
