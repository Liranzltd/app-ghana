...
class Transaction extends \AppBundle\Entity\Transaction implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'mode', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'reference', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'debit', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'credit', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'transactionDate', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'transactionReference', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'remarks', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'status', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\Transaction' . "\0" . 'company'];
        }
    ...
    public function setTransactionDate($transactionDate)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTransactionDate', [$transactionDate]);
