 ...
 */
class VerificationStage extends \AppBundle\Entity\VerificationStage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\VerificationStage' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\VerificationStage' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\VerificationStage' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\VerificationStage' . "\0" . 'steps', '' . "\0" . 'AppBundle\\Entity\\VerificationStage' . "\0" . 'companyType'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VerificationStage $proxy) {
