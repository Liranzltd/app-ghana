 ...
 */
class BuyerSupplierPool extends \AppBundle\Entity\BuyerSupplierPool implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\BuyerSupplierPool' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\BuyerSupplierPool' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\BuyerSupplierPool' . "\0" . 'buyer', '' . "\0" . 'AppBundle\\Entity\\BuyerSupplierPool' . "\0" . 'suppliers'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BuyerSupplierPool $proxy) {
