...
class User extends \Application\Sonata\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Application\\Sonata\\UserBundle\\Entity\\User' . "\0" . 'azureId', '' . "\0" . 'Application\\Sonata\\UserBundle\\Entity\\User' . "\0" . 'azureAccessToken', '' . "\0" . 'Application\\Sonata\\UserBundle\\Entity\\User' . "\0" . 'lastActivityAt', '' . "\0" . 'Application\\Sonata\\UserBundle\\Entity\\User' . "\0" . 'member', 'createdAt', 'updatedAt', 'twoStepVerificationCode', 'dateOfBirth', 'firstname', 'lastname', 'website', 'biography', 'gender', 'locale', 'timezone', 'phone', 'facebookUid', 'facebookName', 'facebookData', 'twitterUid', 'twitterName', 'twitterData', 'gplusUid', 'gplusName', 'gplusData', 'token', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function setAzureAccessToken($azureAccessToken)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAzureAccessToken', [$azureAccessToken]);

        return parent::setAzureAccessToken($azureAccessToken);
    }
    ...
    public function getAzureAccessToken()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAzureAccessToken', []);

        return parent::getAzureAccessToken();
    }
