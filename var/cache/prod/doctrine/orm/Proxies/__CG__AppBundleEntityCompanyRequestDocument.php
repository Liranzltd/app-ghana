 ...
 */
class CompanyRequestDocument extends \AppBundle\Entity\CompanyRequestDocument implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CompanyRequestDocument' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\CompanyRequestDocument' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\CompanyRequestDocument' . "\0" . 'file', '' . "\0" . 'AppBundle\\Entity\\CompanyRequestDocument' . "\0" . 'originalFileName', '' . "\0" . 'AppBundle\\Entity\\CompanyRequestDocument' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\CompanyRequestDocument' . "\0" . 'updatedAt', '' . "\0" . 'AppBundle\\Entity\\CompanyRequestDocument' . "\0" . 'response'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompanyRequestDocument $proxy) {
