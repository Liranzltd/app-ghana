 ...
 */
class CompanyType extends \AppBundle\Entity\CompanyType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CompanyType' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\CompanyType' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\CompanyType' . "\0" . 'requiredDocuments', '' . "\0" . 'AppBundle\\Entity\\CompanyType' . "\0" . 'companies', '' . "\0" . 'AppBundle\\Entity\\CompanyType' . "\0" . 'verificationStages'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompanyType $proxy) {
    ...
    public function addVerificationStage(\AppBundle\Entity\VerificationStage $verificationStage)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addVerificationStage', [$verificationStage]);

        return parent::addVerificationStage($verificationStage);
    }
    ...
    public function removeVerificationStage(\AppBundle\Entity\VerificationStage $verificationStage)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeVerificationStage', [$verificationStage]);

        return parent::removeVerificationStage($verificationStage);
    }
    ...
    public function getVerificationStages()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVerificationStages', []);

        return parent::getVerificationStages();
    }
