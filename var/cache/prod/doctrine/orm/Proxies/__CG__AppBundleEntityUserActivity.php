 ...
 */
class UserActivity extends \AppBundle\Entity\UserActivity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\UserActivity' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\UserActivity' . "\0" . 'activity', '' . "\0" . 'AppBundle\\Entity\\UserActivity' . "\0" . 'module', '' . "\0" . 'AppBundle\\Entity\\UserActivity' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\UserActivity' . "\0" . 'member'];
        }
