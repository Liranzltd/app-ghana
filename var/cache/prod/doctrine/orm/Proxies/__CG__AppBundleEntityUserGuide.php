 ...
 */
class UserGuide extends \AppBundle\Entity\UserGuide implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\UserGuide' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\UserGuide' . "\0" . 'group', '' . "\0" . 'AppBundle\\Entity\\UserGuide' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\UserGuide' . "\0" . 'position', '' . "\0" . 'AppBundle\\Entity\\UserGuide' . "\0" . 'topic', '' . "\0" . 'AppBundle\\Entity\\UserGuide' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\UserGuide' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\UserGuide' . "\0" . 'contentType', '' . "\0" . 'AppBundle\\Entity\\UserGuide' . "\0" . 'media'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserGuide $proxy) {
