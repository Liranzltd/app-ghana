...
return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->load('getDoctrine_Dbal_ConnectionFactoryService.php')) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'admin_appghana', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => [], 'serverVersion' => '5.7', 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, []);
