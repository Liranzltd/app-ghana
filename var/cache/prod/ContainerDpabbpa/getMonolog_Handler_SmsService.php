...
// Returns the private 'monolog.handler.sms' shared service.

$this->services['monolog.handler.sms'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'\\logs/sms.log'), 100, true, NULL, false);
