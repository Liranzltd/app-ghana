...
return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 2 => ${($_ = isset($this->services['hwi_oauth.authentication.listener.oauth.main']) ? $this->services['hwi_oauth.authentication.listener.oauth.main'] : $this->load('getHwiOauth_Authentication_Listener_Oauth_MainService.php')) && false ?: '_'};
