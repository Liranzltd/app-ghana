...
class appProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'app.twig.extension.date' => 'getApp_Twig_Extension_DateService.php',
            ...
            'assetic.asset_factory' => 'getAssetic_AssetFactoryService.php',
            ...
            'hwi_oauth.resource_ownermap.main' => 'getHwiOauth_ResourceOwnermap_MainService.php',
            'hwi_oauth.security.oauth_utils' => 'getHwiOauth_Security_OauthUtilsService.php',
            'hwi_oauth.templating.helper.oauth' => 'getHwiOauth_Templating_Helper_OauthService.php',
            ...
            'ivory_ck_editor.renderer' => 'getIvoryCkEditor_RendererService.php',
            ...
            'ivory_ck_editor.twig_extension' => 'getIvoryCkEditor_TwigExtensionService.php',
            ...
            'sonata.user.matrix_roles_builder' => 'getSonata_User_MatrixRolesBuilderService.php',
            ...
            'twig.extension.sortbyfield' => 'getTwig_Extension_SortbyfieldService.php',
    ...
    {
        $this->services['monolog.handler.main'] = $instance = new \Monolog\Handler\RotatingFileHandler(($this->targetDirs[2].'\\logs/prod.log'), 0, 100, true, NULL);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'KnpSnappyBundle' => [
                    'parent' => NULL,
                    'path' => 'D:/www/appghana/vendor/knplabs/knp-snappy-bundle',
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'assetic.sass.bin' => 'C:\\Ruby26-x64\\bin\\sass.BAT',
