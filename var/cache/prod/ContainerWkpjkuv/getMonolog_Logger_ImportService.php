...
// Returns the public 'monolog.logger.import' shared service.
...
$instance->pushHandler(${($_ = isset($this->services['monolog.handler.import']) ? $this->services['monolog.handler.import'] : $this->load('getMonolog_Handler_ImportService.php')) && false ?: '_'});
