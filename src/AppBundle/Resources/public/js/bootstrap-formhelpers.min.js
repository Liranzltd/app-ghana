...
var BFHCurrenciesList = {
  ...
  'GHS':{'label':'Kenyan shilling','currencyflag':'','symbol':'Sh'},
  ...
  BFHDatePicker.prototype = {
    ...
    initCalendar: function() {
      ...
      this.$element.html(
        ...
        iconLeft +
        '<input type="text" name="' + this.options.name + '" class="' + this.options.input + '" placeholder="' + this.options.placeholder + '" readonly '+this.options.required+'>' +
        iconRight +
        '</div>' +
