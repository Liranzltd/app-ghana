...
class SamlServiceProviderRepository implements ServiceProviderRepository
{
    ...
    public function __construct() {
        $this->spMap["https://kenya-app.hivebrite.com/saml/acs"] = new ServiceProvider(
            [
                /**
                ...
                * @return null|string
                */
                "entityId" => "https://kenya-app.hivebrite.com/saml/acs",
                ...
                */
                ...
                "assertionConsumerUrl" => "https://kenya-app.hivebrite.com/saml/acs",
                "assertionConsumerBinding" => \SAML2_Const::BINDING_HTTP_POST,
                "singleLogoutUrl" => "https://kenya-app.hivebrite.com/saml/logout ",
